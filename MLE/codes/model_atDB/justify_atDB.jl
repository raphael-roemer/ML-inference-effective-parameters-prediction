...
tbd=tbd_t[1:j-1]
writedlm("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/toBeDone.csv",tbd)
=#

# look which intervalls of tbd have still to been done
#=tbdT=readdlm("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_always/toBeDone.csv")
...
mleres
Plots.plot(1:8760,mleres[1:8760,2])
...
function plotInt(hour)
    ...
    for i in 1:900
         TSdp[i]=mleres[hour,5]+mleres[hour,6]*(i-1)
         if i<posOfdbcrossing+turnOn
             TSdpt[i]=TSdp[i]
         else
             TSdpt[i]=TSdp[i]-mleres[hour,4]*TS[i,3]
         end
    end
    TSsigma = sqrt.(abs.(TS[:,2]))
    TSmuPlus = TS[:,1]+TSsigma[:]
...
#png("C:/Users/Raphael Biertz/Desktop/masterarbeit/programs/results/plots/plots-combi-smoothcontrol15/40_2050_pre100_larger_deadband/15combis"*string(hour))
...
tbd[1000]
lkj
#png("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/plots/intsWc/2_"*string(hourp))
...
#Plots.GRBackend()
#gr()
Plots.plot(abs.((mleres[goodfit,5].+(mleres[goodfit,6].*mleres[goodfit,2]))./mleres[goodfit,3]),
    mleres[goodfit,15],
    seriestype=:scatter,
...
corspearman(abs.((mleres[goodfit,5].+(mleres[goodfit,6].*mleres[goodfit,2]))./mleres[goodfit,3]),mleres[goodfit,15])
png("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/plots/validationNadir/2_NadScat")
...
png("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/plots/validationD/2_DScat")
...
Plots.plot(plovald[1],
    ...
    markeralpha=0.99)
plot!(0:0.0001:0.013,0:0.0001:0.013,label="\$\\textrm{expected}\$",color=:green)
png("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/plots/validationD/2_DScat_g1Col")
# color D
...
plot!(0:0.0001:0.013,0:0.0001:0.013,label="\$\\textrm{expected}\$")
png("/Users/raphaelbiertz/Documents/masterarbeit/coding/codes/model_atDB/plots/validationD/2_DScatMu")
# color g1 + g0
plovald=density_plot((0.0,0.013),
    (0.0,0.005),
    (mleres[con,7].^2)./(2*mleres[con,3]),
